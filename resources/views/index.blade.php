...
@section('main')
        ...
        @empty
            <div class="col-6 border">
                <p style="color: green;">You haven't purchashed course yet !</p>
            </div>
        @endforelse
        </div>
        <hr />
                    ...
                    <p>
                        @for ($star = 1; $star <= 5; $star++)
                            @if ($course->rating >= $star)
                                <span class="glyphicon glyphicon-star" style="background-color: yellow;"></span>
                            @else
                                <span class="glyphicon glyphicon-star-empty" style="background-color: red;"></span>
                            @endif
                        @endfor
                    </p>
                </div>
